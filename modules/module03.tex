...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, colback=white, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Trial connection}, left=2mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, breakable, opacityback=0]
